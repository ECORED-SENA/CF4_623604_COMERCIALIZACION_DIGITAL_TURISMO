  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center
      .col-xxl-12.px-5
        .row.justify-content-center
          .col-xxl-6.col-xl-6.col-lg-6.col-md-8.col-sm-11.col-11(data-aos="fade-up-right")
            img.mt-4(src='@/assets/curso/tema2/img07.png')
          .col-xxl-6.col-xl-6.col-lg-6.col-md-8.col-sm-11.col-11(data-aos="fade-up-left")
    ...
    SlyderF(data-aos="fade-up")(columnas="col-lg-4 col-xl-4").mb-5
      ...
      .tarjeta.color-acento-contenido.color12.tranform1.hoverScale2.alt
        ...
        .row.p-3
          ...
          p.p-2.text-dark Puntos de contacto y distribución a través de los cuales se gestionan los contactos con los clientes y se entrega el valor generado por el bien o servicio. 
      .tarjeta.color-acento-contenido.color12.tranform1.hoverScale2.alt
        .row.justify-content-center.mb-3
          .col-12
          ...
          .row.justify-content-center.align-items-center
            ...
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
                  p Para afianzar aún más el conocimiento de este modelo de análisis de negocio se recomienda que consulte el siguiente enlace: 
                .col-lg-3
                  .mt-3
